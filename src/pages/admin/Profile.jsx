...
import { User, Mail, Camera, Shield, Key, Bell, Loader2, CheckCircle2, X } from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500">Quản lý thông tin tài khoản và cài đặt hệ thống</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-1 space-y-6">
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 flex flex-col items-center text-center">
            ...
            <p className="text-gray-500 text-sm capitalize">Quản trị viên hệ thống</p>
          </div>
