...
const faqs = [
  {
    ...
    answer:
      "Để tạo kỳ thi, bạn vào mục 'Quản lý kỳ thi' từ thanh điều hướng của giáo viên, sau đó nhấn nút 'Tạo kỳ thi mới'. Bạn có thể chọn câu hỏi từ ngân hàng câu hỏi hoặc tạo câu hỏi mới.",
  },
  {
    question: 'Tôi có thể nhập câu hỏi từ file Excel không?',
    answer:
      "Có, hệ thống hỗ trợ nhập câu hỏi hàng loạt từ file Excel. Trong mục 'Ngân hàng câu hỏi', hãy chọn 'Import' và tải lên file theo mẫu quy định.",
  },
  {
    question: 'Làm sao để xem kết quả thi của học sinh?',
    answer:
      "Bạn có thể xem kết quả trong mục 'Kết quả thi'. Hệ thống cung cấp báo cáo chi tiết cho từng học sinh và thống kê tổng quan cho cả lớp.",
  },
  {
    question: 'Học sinh tham gia lớp học như thế nào?',
    answer:
      "Học sinh có thể tham gia lớp học bằng cách nhập 'Mã lớp' mà giáo viên cung cấp trong mục 'Tham gia lớp học' trên bảng điều khiển của học sinh.",
  },
];
...
const categories = [
  {
    ...
    description: 'Tài liệu chi tiết cho giáo viên và học sinh',
    count: 12,
  },
  {
    icon: FileText,
  ...
  },
  {
    ...
    description: 'Chat trực tiếp với đội ngũ hỗ trợ kỹ thuật',
    count: 24,
  },
];
    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {categories.map((cat, i) => (
          <div
            key={i}
            className="bg-white dark:bg-slate-900 p-10 rounded-[2.5rem] border border-gray-100 dark:border-slate-800 shadow-xl shadow-gray-200/10 dark:shadow-none hover:shadow-2xl hover:shadow-blue-500/5 transition-all duration-500 group cursor-pointer"
          >
            ...
            <p className="text-gray-500 dark:text-slate-400 text-sm font-medium leading-relaxed mb-6">
              {cat.description}
            </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-8">
          <div className="flex items-center justify-between">
            ...
            <button className="text-sm font-black text-blue-600 hover:underline uppercase tracking-widest">
              Xem tất cả
            </button>
          </div>
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              <details
                key={i}
                className="group bg-white dark:bg-slate-900 rounded-3xl border border-gray-100 dark:border-slate-800 shadow-sm overflow-hidden transition-all hover:border-blue-200"
              >
            ...
            <div className="space-y-6 relative z-10">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="font-bold text-sm">Thành phố Hồ Chí Minh, Việt Nam</p>
                </div>
              </div>
            </div>
