      ...
      <div className="bg-white rounded-2xl shadow-2xl p-8 m-4 max-w-md w-full transform transition-all animate-in zoom-in-95 slide-in-from-bottom-4">
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-gray-600 mt-1">Lớp: <span className="font-semibold">{classroom.name}</span></p>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500 mb-4">Học sinh có thể quét mã QR hoặc sử dụng mã lớp để tham gia.</p>
          ...
          <div className="mt-6">
            ...
            <div className="mt-2 flex items-center justify-center gap-2 bg-blue-50 border-2 border-dashed border-blue-200 rounded-lg px-4 py-3 max-w-xs mx-auto">
              ...
              <button onClick={() => copyToClipboard(classroom.code)} className="p-2 text-blue-600 hover:bg-blue-100 rounded-lg">
          ...
          <div className="mt-6">
            ...
            <div className="mt-2 flex items-center justify-center gap-2 bg-green-50 border border-green-200 rounded-lg px-4 py-2 max-w-xs mx-auto">
              ...
              <button onClick={() => copyToClipboard(joinUrl)} className="p-2 text-green-700 hover:bg-green-100 rounded-lg flex-shrink-0">
                <Copy className="w-5 h-5" />
              </button>
            </div>
          </div>
