...
const sidebarItems = [
  { icon: LayoutDashboard, label: 'Tổng quan', to: '/teacher' },
  { icon: BookOpen, label: 'Ngân hàng câu hỏi', to: '/teacher/questions' },
  { icon: FileText, label: 'Kỳ thi của tôi', to: '/teacher/exams' },
  { icon: BarChart3, label: 'Báo cáo & Kết quả', to: '/teacher/results' },
  { icon: Users, label: 'Quản lý học sinh', to: '/teacher/students' },
  { icon: School, label: 'Lớp học phụ trách', to: '/teacher/classrooms' },
];
